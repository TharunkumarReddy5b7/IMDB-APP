...
namespace MovieApi.Test.StepDefinitions
{
    public class BaseSteps
    {
        ...
        [When(@"I am make POST Request '([^']*)' with the following data '([^']*)'")]
        public virtual async Task WhenIAmMakePOSTRequestWithTheFollowingData(string resourceEndPoint, string postDataJson)
        {
            var postRelativeUri = new Uri(resourceEndPoint, UriKind.Relative);
